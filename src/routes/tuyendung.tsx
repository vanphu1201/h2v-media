...
const jobs = [
  { 
    ...
    img: jobContent,
    details: {
      requirements: ["Có kinh nghiệm quản lý kênh YouTube", "Tiếng Anh đọc hiểu tốt", "Sáng tạo, nắm bắt xu hướng nhanh"],
      benefits: ["Lương thưởng theo view", "Làm việc với đội ngũ triệu sub", "Thiết bị hiện đại"],
  ...
  { 
    ...
    img: jobAuto,
    details: {
      requirements: ["Thành thạo n8n, Make hoặc Zapier", "Biết JavaScript cơ bản", "Tư duy logic tốt"],
      benefits: ["Thử thách với các hệ thống phức tạp", "Môi trường công nghệ cao", "Lương cạnh tranh"],
  ...
  { 
    ...
    img: jobAff,
    details: {
      requirements: ["Am hiểu về CPA, CPL, RevShare", "Kinh nghiệm chạy Ads (FB, Google, TikTok)", "Phân tích số liệu tốt"],
      benefits: ["Commission hấp dẫn", "Ngân sách chạy ads lớn", "Đào tạo bài bản từ chuyên gia"],
  ...
  { 
    ...
    img: jobVideo,
    details: {
      requirements: ["Sử dụng thành thạo Premiere, After Effects", "Có gu thẩm mỹ tốt", "Chịu được áp lực tiến độ"],
      benefits: ["Rèn luyện kỹ năng dựng chuyên sâu", "Thưởng theo chất lượng video", "Môi trường sáng tạo"],
      tasks: ["Dựng video YouTube triệu view", "Thiết kế hiệu ứng motion", "Chỉnh sửa màu sắc & âm thanh"]
    }
  },
  { 
    ...
    img: jobThumb,
    details: {
      requirements: ["Sử dụng tốt Photoshop", "Am hiểu tâm lý người xem YouTube", "Sáng tạo trong bố cục"],
      benefits: ["Học hỏi kỹ thuật tối ưu CTR", "Lương thưởng theo hiệu quả", "Team trẻ trung"],
  ...
  { 
    ...
    img: jobWriter,
    details: {
      requirements: ["Kỹ năng viết tốt, mạch lạc", "Tư duy kể chuyện (Storytelling)", "Biết tiếng Anh là lợi thế"],
      benefits: ["Nâng cao tư duy nội dung", "Làm việc remote linh hoạt", "Thưởng theo dự án"],
      tasks: ["Viết kịch bản video chi tiết", "Sáng tạo nội dung quảng cáo", "Biên tập lại các nội dung cũ"]
    }
  },
];
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center pt-20 overflow-hidden bg-[#040E27]">
        ...
        <div className="container mx-auto px-6 relative z-20">
          <div className="max-w-4xl">
            ...
            >
              Building the <span className="text-gradient italic text-glow">Future</span> of Content.
            </motion.h1>
            ...
            >
              Gia nhập đội ngũ nhân sự tinh anh, cùng chúng tôi kiến tạo những giá trị số bền vững trên quy mô toàn cầu.
            </motion.p>
            ...
            >
              <a href="#vt" className="inline-flex items-center gap-4 px-10 py-5 rounded-full bg-primary text-white font-black uppercase tracking-[0.2em] shadow-glow hover:scale-105 transition-smooth">
      ...
      <section id="ut" className="section-padding bg-white">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter">Giá trị chúng tôi <span className="text-primary italic">cam kết</span></h2>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            {benefits.map((b, i) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-4 group-hover:text-primary transition-colors">{b.title}</h3>
                <p className="text-muted-foreground leading-relaxed font-light text-sm">{b.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section id="vt" className="section-padding bg-secondary/30 relative overflow-hidden">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter">Tham gia <span className="text-primary italic">đội ngũ</span></h2>
          </motion.div>
            ...
            {jobs.map((j, i) => (
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  <img src={j.img} alt={j.title} className="w-full h-full object-cover group-hover:scale-110 transition-all duration-1000 ease-out grayscale-[0.3] group-hover:grayscale-0" />
                  <div className="absolute top-6 left-6">
                    <span className="text-[10px] px-4 py-1.5 rounded-full bg-white/90 backdrop-blur-md text-primary font-black uppercase tracking-widest shadow-sm">Full-time</span>
                  </div>
                ...
                <div className="p-10 flex-grow flex flex-col">
                  ...
                  <h3 className="text-2xl font-bold mb-4 group-hover:text-primary transition-colors tracking-tight">{j.title}</h3>
                  <p className="text-muted-foreground leading-relaxed font-light text-sm mb-8 line-clamp-2">{j.desc}</p>
                  <div className="mt-auto pt-8 border-t border-border/40">
                    ...
                    >
                      Nộp hồ sơ ngay <ArrowRight size={14} className="group-hover/btn:translate-x-1 transition-transform" />
                    </button>
                  </div>
                </div>
              </motion.article>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-10">
            ...
            >
              <div className="lg:w-[45%] relative h-[300px] lg:h-auto">
                <img src={selectedJob.img} alt={selectedJob.title} className="w-full h-full object-cover grayscale-[0.2]" />
                ...
                <div className="absolute bottom-12 left-12 right-12 text-white hidden lg:block">
                  ...
                  <h3 className="text-4xl font-black tracking-tighter mb-4">{selectedJob.title}</h3>
              ...
              <div className="p-8 md:p-16 lg:w-[55%] overflow-y-auto bg-white custom-scrollbar">
                ...
                <div className="lg:hidden mb-12">
                  <h2 className="text-4xl font-black tracking-tighter mb-4">{selectedJob.title}</h2>
                </div>
                  ...
                  <section>
                    ...
                    <ul className="space-y-5">
                      {selectedJob.details.requirements.map((req, i) => (
                        <li key={i} className="flex gap-4 text-muted-foreground font-light leading-relaxed">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-5xl md:text-[5rem] font-black text-white mb-12 tracking-tighter leading-none">
                Sẵn sàng kiến tạo <br /> <span className="text-gradient italic text-glow">tương lai?</span>
              </h2>
              <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto mb-16">
                <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-3xl p-10 text-left">
                  ...
                  <div className="text-[10px] text-white/40 font-black uppercase tracking-widest mb-2">Email</div>
                  <div className="text-xl text-white font-bold">contact@h2vmedia.com</div>
                </div>
                <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-3xl p-10 text-left">
                  <Phone className="text-primary mb-6" size={32} />
                  <div className="text-[10px] text-white/40 font-black uppercase tracking-widest mb-2">Hotline</div>
                  <div className="text-xl text-white font-bold">+84 907 696 177</div>
                </div>
              </div>
              <a href="mailto:contact@h2vmedia.com" className="inline-flex items-center gap-4 px-12 py-6 rounded-full bg-primary text-white font-black uppercase tracking-[0.2em] shadow-glow hover:scale-105 transition-smooth">
